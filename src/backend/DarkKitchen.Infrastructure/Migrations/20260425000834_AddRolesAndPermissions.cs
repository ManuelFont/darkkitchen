    ...
    public partial class AddRolesAndPermissions : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    RoleId = table.Column<int>(type: "int", nullable: false),
                    RolePermissionsPermissionId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissions", x => new { x.RoleId, x.RolePermissionsPermissionId });
                    table.ForeignKey(
                        name: "FK_RolePermissions_Permissions_RolePermissionsPermissionId",
                        column: x => x.RolePermissionsPermissionId,
